...
st.set_page_config(layout="centered", page_title="LedgerFlow", page_icon="icon-192x192.png")
...
st.markdown('<div class="header-bg"><h1>LedgerFlow</h1></div>', unsafe_allow_html=True)
